...
products.map(
    (e) =>{
        let divProduct = `
        <div class="product">
                <div class="product-foto"><img src="${e.image}" alt=""></div>
                <div class="product-data"> 
                    <div class="price">${e.price}</div>
                    <div class="fruit-name">${e.product}</div>
                    <div class="btn-add-product btn" id="${e.id}">Añadir</div>
                </div>
            </div>
        `;
        let divPrd = document.getElementById('products-section');
       
        divPrd.innerHTML += divProduct;
